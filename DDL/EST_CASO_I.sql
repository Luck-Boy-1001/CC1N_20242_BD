    ...
    ALTER TABLE FORNECEDORES ADD COLUMN FORNEC_EMAIL VARCHAR(100);
    ALTER TABLE FORNECEDORES MODIFY FORNEC_ESTADO VARCHAR(2) NOT NULL;
    ALTER TABLE FORNECEDORES DROP COLUMN FORNEC_CONTATO; 
    ALTER TABLE FORNECEDORES ADD CONSTRAINT UC_FORNEC UNIQUE(
    FORNEC_COD, FORNEC_TELEFONE
    );
